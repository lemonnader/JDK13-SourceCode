    ...
    implements List<E>, Deque<E>, Cloneable, java.io.Serializable
{
    ...
    */
    ...
    void linkBefore(E e, Node<E> succ) {
        ...
        final Node<E> pred = succ.prev;// 在其前置节点和后继节点之间创建一个新节点
...
// 否则把next的前置指针置为空
    ...
    E unlink(Node<E> x) {
        ...
        // 如果前置节点为空；说明是首节点，让first指向x的后置节点
    ...
    public E get(int index) {
        ...
        //node(index)函数会根据index的位置选择从后半段/前半段链中顺着找
    ...
    public E remove(int index) {
        // 检查是否越界
        checkElementIndex(index);// 删除指定index位置的节点
